package com.bank.bian.guidelinecompliance.model;
...
/**
 * The BIAN control record for this service domain: "Compliance Check Monitoring State".
 *
 * In BIAN, every Service Domain manages exactly one control record type whose
 * shape follows the domain's functional pattern (Monitor) applied
 * to its asset type (Compliance Check). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Compliance Check Monitoring State";
